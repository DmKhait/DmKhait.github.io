alert( "Здравствуйте! Для удобства проверки кликандера сделал так чтоб вы сами могли задать время срабатывания. По дефолту стоит: 1 час, но можете поменять на 0 часов и, например, 1 минуту чтобы долго не ждать (если сначала кликать с частотой: 1 в час, рекоммендую чистить куки для проверки меньшего временного отрезка ");
