alert( "Здравствуйте! Для удобства проверки кликандера вы сами можете задать время срабатывания. По дефолту стоит: Ютуб 1 час, но можете поменять на 0 часов и пару минут чтоб не ждать");
var url = prompt('Ссылка перехода:', 'http://YouTube.com'); // ссылка перехода
